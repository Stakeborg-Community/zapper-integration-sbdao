...
import type { DaoxToken, DaoxTokenInterface } from '../DaoxToken';
...
export class DaoxToken__factory {
  static readonly abi = _abi;
  static createInterface(): DaoxTokenInterface {
    return new utils.Interface(_abi) as DaoxTokenInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): DaoxToken {
    return new Contract(address, _abi, signerOrProvider) as DaoxToken;
  }
}
