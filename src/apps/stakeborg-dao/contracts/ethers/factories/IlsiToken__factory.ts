...
import type { IlsiToken, IlsiTokenInterface } from '../IlsiToken';
...
export class IlsiToken__factory {
  static readonly abi = _abi;
  static createInterface(): IlsiTokenInterface {
    return new utils.Interface(_abi) as IlsiTokenInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): IlsiToken {
    return new Contract(address, _abi, signerOrProvider) as IlsiToken;
  }
}
